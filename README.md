...
##  Dataset：
### *Synthetic*
We also generated a *Synthetic* dataset containing 500 simulated volatility time series, each generated by a combination of 5 nonlinear functions. The synthetic dataset allows the controllability of the structures/numbers of regimes and the availability of ground truth. To generate these data, we randomly chose one of the 5 functions ten times; every time, this function produces 78 sequential values, which are considered as a regime.
...
## Result (the complete experimental results are shown in the paper and supplementary)
